  ...
  return (
    <section className="bg-white py-16 px-6 sm:px-10 lg:px-20">
      <div className="max-w-4xl mx-auto">
        {/* ===== Section Title ===== */}
        <h2 className="text-center text-2xl sm:text-3xl font-bold font-[Georgia,_serif] text-[#7f7060] mb-10">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <h3 className="font-semibold text-base sm:text-lg font-[Georgia,_serif] text-[#7f7060]">
                  {faq.question}
                </h3>

                {/* ===== Toggle Icon ===== */}
                <span className="text-[#7f7060] flex-shrink-0">
                  {openIndex === index ? (
